...
//Deklarerar pinnar som ska användas till Led
const int LED_PIN = 5;
...
//Konstanter för att kunna anslusta via TCP
const char* ssid = "Ali";
...
//För att uppdatera från servern
const unsigned long updateInterval = 100;
unsigned long lastUpdate = 0;

//Deklerar hur man blinakde interval
const unsigned long blinkInterval = 750;
unsigned long lastBlink = 0;

//Deklarera vilka pins som är rad och vilken som är rad
const int rowPins[8] = {13, 14, 15, 16, 17, 18, 19, 21};
const int colPins[8] = {25, 26, 27, 32, 33, 34, 35, 36};// alla har pullup

//
unsigned long lastDebounceTime[64] = {0};
...
void loop() {
  ...
  for(int r = 0; r < 8; r++) {
    ...
    delayMicroseconds(50);//liten delay for stabilisering
    ...
    delayMicroseconds(50);//delay innan nästa rad
  }
